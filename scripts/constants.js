...
const addresses = chainId === 1 ?
    {
        ...
        LIQUIDATE_LOAN: "0x47c05bcca7d57c87083eb4e586007530ee4539e9",
...
const routes = chainId === 1 ?
    {
        DAI: {
            ...
            WETH: ethers.utils.solidityPack(["address","uint24","address"],[DAI,30,WETH]),
            wstETH: ethers.utils.solidityPack(["address","uint24","address"],[DAI,30,WETH]),
            WBTC: ethers.utils.solidityPack(["address","uint24","address","uint24","address"],[DAI,30,WETH,30,WBTC]),
        },
        sDAI: {
            DAI: ethers.utils.solidityPack([],[]),
            sDAI: ethers.utils.solidityPack([],[]),
        ...
        WETH: {
            DAI: ethers.utils.solidityPack(["address","uint24","address"],[WETH,30,DAI]),
            sDAI: ethers.utils.solidityPack(["address","uint24","address"],[WETH,30,DAI]),
            WETH: ethers.utils.solidityPack([],[]),
            wstETH: ethers.utils.solidityPack([],[]),
            WBTC: ethers.utils.solidityPack(["address","uint24","address"],[WETH,30,WBTC]),
        },
        wstETH: {
            DAI: ethers.utils.solidityPack(["address","uint24","address"],[WETH,30,DAI]),
            sDAI: ethers.utils.solidityPack(["address","uint24","address"],[WETH,30,DAI]),
        ...
        WBTC: {
            DAI: ethers.utils.solidityPack(["address","uint24","address","uint24","address"],[WBTC,30,WETH,30,DAI]),
            sDAI: ethers.utils.solidityPack(["address","uint24","address"],[WBTC,500,DAI]),
            WETH: ethers.utils.solidityPack(["address","uint24","address"],[WBTC,30,WETH]),
            wstETH: ethers.utils.solidityPack(["address","uint24","address"],[WBTC,30,WETH]),
